...
module.exports = __webpack_require__.p + "img/Spotify_Logo_CMYK_White.31bad8d.png";
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "::-webkit-scrollbar{width:8px}::-webkit-scrollbar-track{background-color:#1f1f1f}::-webkit-scrollbar-thumb{background-color:#444;border-radius:9999px}", ""]);
// Exports
module.exports = exports;
...
const _db925982 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 1).then(__webpack_require__.bind(null, 49))); // TODO: remove in Nuxt 3
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container-inner mx-auto py-16"},[_vm._ssrNode(((_vm.error.statusCode === 404)?("<div><h2 class=\"text-4xl font-bold mb-16\">Page Not Found</h2> <img"+(_vm._ssrAttr("src",__webpack_require__(20)))+" alt=\"404 page not foud\"></div>"):("<div><h2>An error occured</h2></div>")))])}
var staticRenderFns = []
...
var prism_material_oceanic = __webpack_require__(27);

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=5e808a78&
var defaultvue_type_template_id_5e808a78_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"flex"},[_vm._ssrNode("<div class=\"bg-black\">","</div>",[_vm._ssrNode("<div class=\"bg-black  mt-8 text-white w-46 mx-6 flex-none flex flex-col\">","</div>",[_vm._ssrNode("<img"+(_vm._ssrAttr("src",__webpack_require__(29)))+" alt class=\"mx-auto w-48 h-15 mt-4 shadow-lg\"> "),_vm._ssrNode("<ul class=\"px-3 py-2 pt-8\">","</ul>",[_vm._ssrNode("<li class=\"mb-2\">","</li>",[_c('nuxt-link',{attrs:{"to":"/","exact-active-class":"font-bold"}},[_c('span',{staticClass:"text-white text-sm hover:text-white transition-colors duration-300 hover:opacity-50 cursor-pointer"},[_vm._v("Home")])])],1),_vm._ssrNode(" "),_vm._ssrNode("<li class=\"mb-2\">","</li>",[_c('nuxt-link',{attrs:{"to":"/search","exact-active-class":"font-bold"}},[_c('span',{staticClass:"text-white text-sm hover:text-white transition-colors duration-300 hover:opacity-50 cursor-pointer"},[_vm._v("Search")])])],1),_vm._ssrNode(" "),_vm._ssrNode("<li class=\"mb-8\">","</li>",[_c('nuxt-link',{attrs:{"to":"/your-library","exact-active-class":"font-bold"}},[_c('span',{staticClass:"text-white text-sm hover:text-white transition-colors duration-300 hover:opacity-50 cursor-pointer"},[_vm._v("Your Library")])])],1),_vm._ssrNode(" "),_vm._ssrNode("<li class=\"mb-2\">","</li>",[_c('nuxt-link',{attrs:{"to":"/create-playlist","exact-active-class":"font-bold"}},[_c('span',{staticClass:"text-white text-sm hover:text-white transition-colors duration-300 hover:opacity-50 cursor-pointer"},[_vm._v("Create Playlist")])])],1),_vm._ssrNode(" "),_vm._ssrNode("<li class=\"mb-2\">","</li>",[_c('nuxt-link',{attrs:{"to":"/liked-song","exact-active-class":"font-bold"}},[_c('span',{staticClass:"text-white text-sm hover:text-white transition-colors duration-300 hover:opacity-50 cursor-pointer"},[_vm._v("Liked Song")])])],1)],2),_vm._ssrNode(" <div class=\"px-3\"><div class=\"flex gap-4 py-2\"><p class=\"text-xs hover:opacity-50 cursor-pointer\">Legal</p> <p class=\"text-xs hover:opacity-50 cursor-pointer\">Privacy Center</p></div> <div class=\"flex gap-4 py-2\"><p class=\"text-xs hover:opacity-50 cursor-pointer\">Privacy Policy</p> <p class=\"text-sm hover:opacity-50 cursor-pointer\">Cookies</p></div> <p class=\"text-xs py-2 hover:opacity-50 cursor-pointer\">About Ads</p> <p class=\"text-xs py-2 mb-4 hover:opacity-50 cursor-pointer\">Cookies</p> <button class=\"bg-transparent hover:opacity-50 cursor-pointer pb-4text-white border-white border py-2 px-8 rounded-full font-bold\">English</button></div>")],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"flex-1\">","</div>",[_c('nuxt')],1)],2)}
var defaultvue_type_template_id_5e808a78_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=5e808a78&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  script,
  defaultvue_type_template_id_5e808a78_render,
  defaultvue_type_template_id_5e808a78_staticRenderFns,
  false,
...
var fontawesome_svg_core_ = __webpack_require__(16);
